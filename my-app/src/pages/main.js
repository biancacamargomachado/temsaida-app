          ...
          <div style={{ width: 310 }}>
            ...
            <Stack direction="column" spacing={2}>
                ...
                <Button style={customButtonStyle} startIcon={<DownloadIcon />} variant="contained">
                  <a alt="Criar Currículo" href="https://res.cloudinary.com/app-temsaida/image/upload/v1643541647/curriculo-maria_ljazct.png" target='_blank' rel="noreferrer">Criar Currículo</a>
                </Button>
